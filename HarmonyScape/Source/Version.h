...
#define HARMONYSCAPE_BUILD_NUMBER 1034

// Build color for visual identification - changes each build
#define BUILD_COLOR_R 0.0f
#define BUILD_COLOR_G 0.0f
#define BUILD_COLOR_B 1.0f

// Version string
#define HARMONYSCAPE_VERSION_STRING "1.0.1034"
